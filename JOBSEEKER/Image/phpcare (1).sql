...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3043536615ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="180">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=users">`phpcare`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=specialities">`phpcare`.`specialities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=patients">`phpcare`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=doctors">`phpcare`.`doctors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=cities">`phpcare`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=availabilities">`phpcare`.`availabilities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=appointments">`phpcare`.`appointments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=admins">`phpcare`.`admins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=availability">`phpcare`.`availability`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpcare&table=speciality">`phpcare`.`speciality`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="512a326246736f6a4a3936216b2c3641">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="180"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="phpcare" targettable="doctors">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctors`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="doctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctors`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="appointments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointments`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="doctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctors`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="patients">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `patients`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appointments`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="availabilities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `availabilities`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="cities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `cities`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="doctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `patients`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="specialities">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `specialities`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpcare" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
